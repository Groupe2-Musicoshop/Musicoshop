...
<div class="jumbotron">
    ...
    <div id="cart" class="body-mu">
        ...
        <div class="row">
       <div class="center col-4"> <a href="../Musicoshop/paiement.php"  class="btn btn-primary btn-lg btn-block" role="button" aria-pressed="true">Passer votre commande</a></div>
</div>
    </div>
